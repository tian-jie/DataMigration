...
{
    public class Lilly_TC_Data_WechatPush_Temp : KwEntityBase<int>
    {
        ...
        public virtual DateTime Push_dt { get; set; }
        public virtual DateTime? Process_dt { get; set; }
        public virtual int? Try_num { get; set; }
